...
<div class="graph-modal__container" role="dialog" aria-modal="true" id="thanks" data-graph-target="successfully">
    ...
    <div class="graph-modal__content">
      <div class="successfully">
        ...
        <!-- <button class="btn-reset button-pr" data-thanks-modal>ok</button> -->
      </div>
    </div>
</div>