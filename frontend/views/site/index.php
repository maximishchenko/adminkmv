...
<!-- <script src="https://api-maps.yandex.ru/2.1/?apikey=<?php // echo Yii::$app->configManager->getItemValue('mapApiKey'); ?>&lang=ru_RU" type="text/javascript"></script> -->
...
setTimeout(function(){
	...
	elem.src = '//api-maps.yandex.ru/2.1/?apikey=<?= Yii::$app->configManager->getItemValue('mapApiKey'); ?>&load=package.standard&lang=ru-RU&onload=getYaMap';
